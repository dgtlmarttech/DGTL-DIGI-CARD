...
export default function PersonalAssistantDashboard() {
  ...
  if (userLoading || !userInfo?.hasAccess) {
    return (
          ...
          <div className="lg:col-span-2 flex flex-col h-full">
            ...
            <div className="flex bg-white rounded-xl shadow-sm p-1 mb-6 border border-gray-100">
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-lg text-sm font-semibold transition-all ${activeTab === 'todo' ? 'bg-purple-50 text-purple-700 shadow-sm' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'
                  }`}
              >
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-lg text-sm font-semibold transition-all ${activeTab === 'meetings' ? 'bg-purple-50 text-purple-700 shadow-sm' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'
                  }`}
              >
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-lg text-sm font-semibold transition-all ${activeTab === 'voice' ? 'bg-purple-50 text-purple-700 shadow-sm' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'
                  }`}
              >
