  ...
  const shareContact = async () => {
    ...
    try {
      if (navigator.share) {
        ...
        // Using alert if toast is not available, but assuming it was meant to be copied
            ...
            <div className="p-6">
              <div className="text-center mb-6">
                <div className="w-24 h-24 mx-auto mb-4 rounded-3xl overflow-hidden border-4 border-purple-100">
                  {userInfo.imgUrl ? (
                    <img src={userInfo.imgUrl} alt={userInfo.firstName} className="w-full h-full object-cover" />
                  ) : (
            ...
            <div className="p-4 space-y-3">
              ...
              {userInfo.website && (
                <div className="flex items-center gap-4 p-4 bg-purple-50 rounded-xl">
                  ...
                  <a href={getClickableLink(userInfo.website)} target="_blank" rel="noopener noreferrer" className="p-2 bg-purple-100 rounded-lg hover:bg-purple-200 transition-colors">
