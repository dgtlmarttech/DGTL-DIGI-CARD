...
/**
 * Props:
 * - userInfo: { imgUrl, businessName, website, firstName, lastName, mobile, email, address, about, customUID, uid }
 */
export default function ContactCard6({ userInfo }) {
...
END:VCARD`;
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url('/card-bg-6.jpg')`,
